...
//            deleteCourseById(appDao);
    ...
    private void updateStudent(AppDao appDao) {
        ...
        Student s = appDao.findStudentAndCourseById(1);

        s.addCourse(new Course("Java"));
        s.addCourse(new Course("Python"));
        s.addCourse(new Course("Cpp"));
    ...
    private void findStudentAndCourse(AppDao appDao) {
        ...
        Student s = appDao.findStudentAndCourseById(id);
    ...
    private void findCourseAndStudent(AppDao appDao) {
        ...
        Course c = appDao.findCourseAndStudentById(id);
    ...
    private void createCourseAndStudent(AppDao appDao) {
        ...
        Course c = new Course("Spring Boot Intro Course" );
        c.addStudent(new Student("ahmed@gmail.com" , "Hussein" , "Ahmed"));
        c.addStudent(new Student("ahmed2@gmail.com" , "Hussein2" , "Ahmed2"));
